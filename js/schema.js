  ...
  modules: [
    {
      ...
      fields: [
        ...
        { kind: 'multi', name: 'a_hunt_reasons', label: 'Why do you hunt? (choose any that apply)',
          options: 'hunt_reasons',
          help: 'More than one reason is fine. Record all they give.',
          showIf: { field: 'activity_type', notEquals: 'fish' } },
        { kind: 'text', name: 'a_hunt_reasons_other', label: 'Other reason (specify)',
          showIf: { field: 'a_hunt_reasons', includes: 'other' } },
    ...
    },
    {
      ...
      fields: [
        ...
        { kind: 'text', name: 'c_method_other_specify',
          label: 'If you ticked "Other" (tool 20) for any animal, specify which tool(s)' },
        ...
        { kind: 'textarea', name: 'c_changes_notes',
          ...
          help: 'Prompt the respondent. Record verbatim. No length limit.' },
        { kind: 'single', name: 'c_tool_restrictions',
          label: 'Are any hunting tools not allowed here (tambu, banned, or discouraged)?',
          options: 'yes_no_notsure' },
        { kind: 'textarea', name: 'c_tool_restrictions_text', label: 'Which tools, and why? (verbatim)',
          help: 'Record the respondent’s words — which tools, and the reason (tambu, clan rule, government, etc.).',
          showIf: { field: 'c_tool_restrictions', equals: 'yes' } },
      ],
    },
    {
